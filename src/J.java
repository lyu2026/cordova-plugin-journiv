...
public class J extends CordovaPlugin{
	...
	class D extends SQLiteOpenHelper{
		...
		JSONArray allRaw(){synchronized(L){JSONArray a=new JSONArray();Cursor c=getReadableDatabase().rawQuery("SELECT * FROM o ORDER BY at DESC",null);while(c.moveToNext())a.put(row(c));c.close();return a;}}
